...
def setup():
    ...
    shelltools.export("GRUB_CONTRIB", "%s/grub-2.04/grub-extras" %
                      (get.workDIR()))

    pisitools.cflags.remove("-fstack-protector",
...
def install():
    ...
    pisitools.insinto("/boot/grub2", "ascii.pf2")

    pisitools.insinto("/boot/grub2", "unicode.pf2")

    autotools.rawInstall("DESTDIR=%s" % get.installDIR())

    pisitools.dodoc("ABOUT-NLS", "AUTHORS", "BUGS", "ChangeLog", "COPYING",
                    "TODO", "README")
